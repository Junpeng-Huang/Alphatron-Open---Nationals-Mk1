...
oAvoidance::Movement oAvoidance::moveDirection(double lineAngle){
    ...
    case 1:
        ...
        else if (smallestAngleBetween(lineAngle, original_line) >= 100){ //If new line is on opposite side of robot: Outside field of play
    ...
    case -1:
        ...
        else if (smallestAngleBetween(lineAngle, original_line) < 75){ //Moved back inside field of play
            movement.direction = lineAngle;
            movement.speed = LS_AVOID_MEDIUM;
            botlocation = 1;
